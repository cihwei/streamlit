...
st.pyplot(fig, transparent=True) #透視度 #也可以設定底色
...
# Streamlit run "C:\test\07-Value-at-Risk-rolling().quantile()-VaR_Normal-DataFrame.plot()-matplotlib-plotly-臺灣證券交易所發行量加權股價指數成分股暨市值比重-streamlit1(1).py"
